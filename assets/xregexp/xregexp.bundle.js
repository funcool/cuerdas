...
var isForced_1 = isForced;var path = {};var aFunction$1 = function (it) {
...
});var defineProperty$3 = defineProperty_1;var defineProperty$2 = defineProperty$3;var interopRequireDefault = createCommonjsModule(function (module) {
...
};var engineIsNode = classofRaw(global$1.process) == 'process';var aFunction = function (variable) {
...
};var engineUserAgent = getBuiltIn('navigator', 'userAgent') || '';var process = global$1.process;
...
var useSymbolAsUid = nativeSymbol
  && !Symbol.sham
  && typeof Symbol.iterator == 'symbol';var WellKnownSymbolsStore$1 = shared('wks');
...
};var slice$4 = entryVirtual('Array').slice;var ArrayPrototype$7 = Array.prototype;

var slice_1 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$7 || (it instanceof Array && own === ArrayPrototype$7.slice) ? slice$4 : own;
};var slice$3 = slice_1;var slice$2 = slice$3;// `String.prototype.{ codePointAt, at }` methods implementation
...
var inspectSource = sharedStore.inspectSource;var WeakMap$1 = global$1.WeakMap;

var nativeWeakMap = typeof WeakMap$1 === 'function' && /native code/.test(inspectSource(WeakMap$1));var keys = shared('keys');
...
}() : undefined);var redefine = function (target, key, value, options) {
...
_export({ target: 'Array', stat: true, forced: INCORRECT_ITERATION }, {
  from: arrayFrom
});var from$4 = path.Array.from;var from$3 = from$4;var from$2 = from$3;var SPECIES = wellKnownSymbol('species');
...
hiddenKeys$1[HIDDEN] = true;// `Symbol.asyncIterator` well-known symbol
...
setToStringTag(global$1.JSON, 'JSON', true);var symbol$4 = path.Symbol;var symbol$3 = symbol$4;var symbol$2 = symbol$3;var ARRAY_ITERATOR = 'Array Iterator';
...
}var getIteratorMethod_1 = getIteratorMethod$1;var getIteratorMethod = getIteratorMethod_1;// `Array.isArray` method
// https://tc39.es/ecma262/#sec-array.isarray
_export({ target: 'Array', stat: true }, {
  isArray: isArray$5
});var isArray$4 = path.Array.isArray;var isArray$3 = isArray$4;var isArray$2 = isArray$3;var getIterator$1 = function (it) {
  var iteratorMethod = getIteratorMethod$1(it);
  if (typeof iteratorMethod != 'function') {
    throw TypeError(String(it) + ' is not iterable');
  } return anObject(iteratorMethod.call(it));
};var getIterator_1 = getIterator$1;var getIterator = getIterator_1;var isArray$1 = isArray$4;var isArray = isArray$1;var arrayWithHoles = createCommonjsModule(function (module) {
...
var symbol$1 = symbol$4;var symbol = symbol$1;var iterableToArrayLimit = createCommonjsModule(function (module) {
...
module.exports["default"] = module.exports, module.exports.__esModule = true;
});var slice$1 = slice_1;var slice = slice$1;var from$1 = from$4;var from = from$1;var arrayLikeToArray = createCommonjsModule(function (module) {
...
var flags_1 = function (it) {
  return (it === RegExpPrototype || it instanceof RegExp) && !('flags' in it) ? flags_1$1(it) : it.flags;
};var flags$1 = flags_1;var flags = flags$1;var arrayMethodIsStrict = function (METHOD_NAME, argument) {
...
});var sort$2 = entryVirtual('Array').sort;var ArrayPrototype$5 = Array.prototype;

var sort_1 = function (it) {
  var own = it.sort;
  return it === ArrayPrototype$5 || (it instanceof Array && own === ArrayPrototype$5.sort) ? sort$2 : own;
};var sort$1 = sort_1;var sort = sort$1;// a string of all valid unicode whitespaces
var whitespaces = '\u0009\u000A\u000B\u000C\u000D\u0020\u00A0\u1680\u2000\u2001\u2002' +
...
});var _parseInt$2 = path.parseInt;var _parseInt$1 = _parseInt$2;var _parseInt = _parseInt$1;/* eslint-disable es/no-array-prototype-indexof -- required for testing */
...
});var indexOf$2 = entryVirtual('Array').indexOf;var ArrayPrototype$4 = Array.prototype;

var indexOf_1 = function (it) {
  var own = it.indexOf;
  return it === ArrayPrototype$4 || (it instanceof Array && own === ArrayPrototype$4.indexOf) ? indexOf$2 : own;
};var indexOf$1 = indexOf_1;var indexOf = indexOf$1;var $forEach = arrayIteration.forEach;
...
});var forEach$2 = entryVirtual('Array').forEach;var forEach$1 = forEach$2;var ArrayPrototype$3 = Array.prototype;
...
};var forEach = forEach_1;// `Object.create` method
// https://tc39.es/ecma262/#sec-object.create
...
};var create$1 = create$2;var create = create$1;var concat$2 = entryVirtual('Array').concat;var ArrayPrototype$2 = Array.prototype;

var concat_1 = function (it) {
  var own = it.concat;
  return it === ArrayPrototype$2 || (it instanceof Array && own === ArrayPrototype$2.concat) ? concat$2 : own;
};var concat$1 = concat_1;var concat = concat$1;var xregexp = createCommonjsModule(function (module, exports) {
...
});var reduce$2 = entryVirtual('Array').reduce;var ArrayPrototype$1 = Array.prototype;

var reduce_1 = function (it) {
  var own = it.reduce;
  return it === ArrayPrototype$1 || (it instanceof Array && own === ArrayPrototype$1.reduce) ? reduce$2 : own;
};var reduce$1 = reduce_1;var reduce = reduce$1;var $map = arrayIteration.map;
...
});var map$2 = entryVirtual('Array').map;var ArrayPrototype = Array.prototype;

var map_1 = function (it) {
  var own = it.map;
  return it === ArrayPrototype || (it instanceof Array && own === ArrayPrototype.map) ? map$2 : own;
};var map$1 = map_1;var map = map$1;var build = createCommonjsModule(function (module, exports) {
...
var _reduce = interopRequireDefault(reduce);
...
var XRegExp = /*@__PURE__*/getDefaultExportFromCjs(lib);return XRegExp;}());