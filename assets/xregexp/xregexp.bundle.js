...
unwrapExports(interopRequireDefault);var check = function (it) {
...
});var defineProperty = defineProperty_1;var defineProperty$1 = defineProperty;// `IsArray` abstract operation
...
};var concat = entryVirtual('Array').concat;var ArrayPrototype = Array.prototype;

var concat_1 = function (it) {
  var own = it.concat;
  return it === ArrayPrototype || (it instanceof Array && own === ArrayPrototype.concat) ? concat : own;
};var concat$1 = concat_1;var concat$2 = concat$1;var max = Math.max;
var min$1 = Math.min;
...
});var indexOf = entryVirtual('Array').indexOf;var ArrayPrototype$1 = Array.prototype;

var indexOf_1 = function (it) {
  var own = it.indexOf;
  return it === ArrayPrototype$1 || (it instanceof Array && own === ArrayPrototype$1.indexOf) ? indexOf : own;
};var indexOf$1 = indexOf_1;var indexOf$2 = indexOf$1;var hiddenKeys = {};var indexOf$3 = arrayIncludes.indexOf;
...
};var create$1 = create;var create$2 = create$1;// `Array.isArray` method
// https://tc39.github.io/ecma262/#sec-array.isarray
_export({ target: 'Array', stat: true }, {
  isArray: isArray
});var isArray$1 = path.Array.isArray;var isArray$2 = isArray$1;var isArray$3 = isArray$2;function _arrayWithHoles(arr) {
  if (isArray$3(arr)) return arr;
}

var arrayWithHoles = _arrayWithHoles;var iterators = {};var functionToString = Function.toString;
...
var inspectSource = sharedStore.inspectSource;var WeakMap = global_1.WeakMap;

var nativeWeakMap = typeof WeakMap === 'function' && /native code/.test(inspectSource(WeakMap));var WeakMap$1 = global_1.WeakMap;
var set, get, has$1;
...
};var getIterator_1 = getIterator;var getIterator$1 = getIterator_1;var ITERATOR$3 = wellKnownSymbol('iterator');
...
};var isIterable_1 = isIterable;var isIterable$1 = isIterable_1;var hiddenKeys$1 = enumBugKeys.concat('length', 'prototype');
...
hiddenKeys[HIDDEN] = true;// `Symbol.asyncIterator` well-known symbol
...
setToStringTag(global_1.JSON, 'JSON', true);var symbol = path.Symbol;// `Symbol.asyncDispose` well-known symbol
...
var symbol$1 = symbol;var symbol$2 = symbol$1;function _iterableToArrayLimit(arr, i) {
...
var iterableToArrayLimit = _iterableToArrayLimit;// call something on iterator step with safe closing on error
...
_export({ target: 'Array', stat: true, forced: INCORRECT_ITERATION }, {
  from: arrayFrom
});var from_1 = path.Array.from;var from_1$1 = from_1;var from_1$2 = from_1$1;var HAS_SPECIES_SUPPORT = arrayMethodHasSpeciesSupport('slice');
...
});var slice = entryVirtual('Array').slice;var ArrayPrototype$3 = Array.prototype;

var slice_1 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$3 || (it instanceof Array && own === ArrayPrototype$3.slice) ? slice : own;
};var slice$1 = slice_1;var slice$2 = slice$1;function _arrayLikeToArray(arr, len) {
...
var slicedToArray = _slicedToArray;var $forEach$1 = arrayIteration.forEach;
...
});var forEach = entryVirtual('Array').forEach;var forEach$1 = forEach;var ArrayPrototype$4 = Array.prototype;
...
};var forEach$2 = forEach_1;var $includes = arrayIncludes.includes;
...
});var includes = entryVirtual('Array').includes;var MATCH = wellKnownSymbol('match');
...
});var includes$1 = entryVirtual('String').includes;var ArrayPrototype$5 = Array.prototype;
...
};var includes$3 = includes$2;var includes$4 = includes$3;// a string of all valid unicode whitespaces
...
});var _parseInt = path.parseInt;var _parseInt$1 = _parseInt;var _parseInt$2 = _parseInt$1;var slice$3 = slice_1;var slice$4 = slice$3;var test$1 = [];
...
});var sort = entryVirtual('Array').sort;var ArrayPrototype$6 = Array.prototype;

var sort_1 = function (it) {
  var own = it.sort;
  return it === ArrayPrototype$6 || (it instanceof Array && own === ArrayPrototype$6.sort) ? sort : own;
};var sort$1 = sort_1;var sort$2 = sort$1;// `RegExp.prototype.flags` getter implementation
...
};var flags = flags_1$1;var flags$1 = flags;var xregexp = createCommonjsModule(function (module, exports) {
...
unwrapExports(xregexp);var $map = arrayIteration.map;
...
});var map = entryVirtual('Array').map;var ArrayPrototype$7 = Array.prototype;

var map_1 = function (it) {
  var own = it.map;
  return it === ArrayPrototype$7 || (it instanceof Array && own === ArrayPrototype$7.map) ? map : own;
};var map$1 = map_1;var map$2 = map$1;// `Array.prototype.{ reduce, reduceRight }` methods implementation
...
});var reduce = entryVirtual('Array').reduce;var ArrayPrototype$8 = Array.prototype;

var reduce_1 = function (it) {
  var own = it.reduce;
  return it === ArrayPrototype$8 || (it instanceof Array && own === ArrayPrototype$8.reduce) ? reduce : own;
};var reduce$1 = reduce_1;var reduce$2 = reduce$1;var build = createCommonjsModule(function (module, exports) {
...
unwrapExports(build);var matchrecursive = createCommonjsModule(function (module, exports) {
...
unwrapExports(matchrecursive);var unicodeBase = createCommonjsModule(function (module, exports) {
...
unwrapExports(unicodeBase);var blocks = [
    {
        'name': 'InAdlam',
        'astral': '\uD83A[\uDD00-\uDD5F]'
    },
...
unwrapExports(unicodeBlocks);var categories = [
    {
        'name': 'C',
        'alias': 'Other',
        'isBmpLast': true,
...
unwrapExports(unicodeCategories);var properties = [
    {
        'name': 'ASCII',
        'bmp': '\0-\x7F'
    },
...
unwrapExports(unicodeProperties);var scripts = [
    {
        'name': 'Adlam',
        'astral': '\uD83A[\uDD00-\uDD4B\uDD50-\uDD59\uDD5E\uDD5F]'
    },
...
unwrapExports(unicodeScripts);var lib = createCommonjsModule(function (module, exports) {
